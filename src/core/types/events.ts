...
export type MutationAction =
  ...
  | 'CREATE_BATCH'     | 'UPDATE_BATCH'     | 'REPORT_DAMAGE' | 'DELETE_BATCH' | 'BULK_UPDATE_BATCH_PRICES' | 'BULK_MARGIN_PRICE_UPDATE' | 'BULK_MANUAL_PRICE_UPDATE' | 'RESTORE_BATCH' | 'PROPAGATE_SELLING_PRICE'
  ...
  | 'CREATE_CASH_DROP' | 'CREATE_CASH_EXCHANGE'
  ...
  | 'REVERSE_ADJUSTMENT' | 'CREATE_CYCLE_COUNT' | 'START_CYCLE_COUNT' | 'RECORD_CYCLE_COUNT_ITEM' | 'COMPLETE_CYCLE_COUNT';
