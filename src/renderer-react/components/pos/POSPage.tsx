...
export function POSPage() {
  ...
  return (
    <div className="flex h-full flex-col">
      ...
      {shiftsEnabled && currentShift && isStaleShift && (
        <div className="flex items-center gap-3 rounded-lg border border-red-300 bg-red-50 px-4 py-3 dark:border-red-700 dark:bg-red-950/50">
          ...
          <p className="flex-1 text-sm font-medium text-red-800 dark:text-red-200">
            {t('Your shift has been open for over 24 hours. Please close it and open a new one to keep cash tracking accurate.')}
          </p>
        </div>
      )}
